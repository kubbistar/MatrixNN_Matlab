...
err = [];
layerSize{2}.Is = 1:100;%the 'Warning: Matrix is close to singular or badly scaled.' means the inversed matrix is not good to provide a stable beta, since Matrix is close to singular.

for i = 1:length(layerSize{2}.Is)
    layerSize{2}.I=layerSize{2}.Is(i);
%if nargin < 4
    maxIters = 100;
%end
%if nargin < 3
...
% You may test different sizes
    ...
    %layerSize{2}.I = 100; 
    layerSize{2}.J = 40; % the size of hidden layer
...
% lambda = 0.319         % weight decay parameter
% beta = 2.0;  %3;               % weight of sparsity penalty term
% 
    maxIters = 10;    % 1000
%%======================================================================
