...
err = [];
betas = 0:0.05:3.5;%the 'Warning: Matrix is close to singular or badly scaled.' means the inversed matrix is not good to provide a stable beta, since Matrix is close to singular.

for i = 1:length(betas)
    beta=betas(i); %testing err
%if nargin < 4
    maxIters = 100;
%end
%if nargin < 3
